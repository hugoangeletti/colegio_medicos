...
<body onLoad="document.forms['myForm'].submit()">
    ...
    if ($continua){
        ...
        if ($resColegiado['estado'] && $resColegiado['datos']) {
            ...
            $pdf->Ln(5);
            $pdf->SetFont('dejavusans', '', 10);
            $pdf->MultiCell(0, $alturaLinea, 'Nº '.rellenarCeros($idCertificado, 8), 0, 'R', false, 0, '50', '');
            $pdf->Ln(10);
            ...
            if ($conDetalle) {
                ...
                if ($conDomicilio) {
                    ...
                    if ($resContacto['estado']) {
                        ...
                        $indice += 1;
                        $pdf->MultiCell(0, $alturaLinea, $indice.'. Teléfonos: '.$telefonos, 0, 'L', false, 0, '', '', true);
                        if ($idTipoCertificado == 10) {
                            //para la caja imprimo el mail
                            $pdf->MultiCell(0, $alturaLinea, 'Mail: '.$mail, 0, 'L', false, 1, '100', '', true);
                        } else {
                            //salto la linea
            ...
            if ($conNota) {
                ...
                if ($idTipoCertificado == 1) {
                    ...
                    $html = '<p style="line-height: 15em;">NOTA: conforme lo expresa el Artículo 7º del Reglamento de Matriculación: '.
                        '"... el médico que ejerza en otro u otros distritos deberá presentarse a los respectivos '.
                        'Colegios para la debida constancia administrativa y el registro correspondiente..",. </p>';
                }
                $pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, 'J', true);
            }
            ...
            if ($conFirma == 'S') {
                ...
                $resFirmante = $colegiadoLogic->obtenerFirmaPorCargo(2); //2: secretariogeneral
