...
//                // Title
        ...
        imprimirGrilla($this, $p1y, $alturaLinea);
    }
...
$tipoListado = "Listado alfabético de asistentes.";
...
if ($continua) {
    ...
    if ($resAsistentes['estado'] && sizeof($resAsistentes['datos']) > 0) {
        ...
        foreach ($resAsistentes['datos'] as $dato){
            ...
            //$pdf->Ln(2);
            imprimirGrilla($pdf, $p1y, $alturaLinea);
            $pdf->SetXY(0, $p1y+2);
            $pdf->MultiCell(0, 0, substr($apellidoNombre, 0, 35), 0, 'L', false, 1, '5', '');
        ...
        echo "ERROR Asistentes->".$resAsistentes['mensaje'];
        echo '<br><b>Cerrar esta pestaña.</b>';
    }
} else {
    echo 'ERROR: '.$mensaje;
    echo '<br><b>Cerrar esta pestaña.</b>';
