...
//                    $firmaVer = base64_encode($contents);
            ...
            */
            ...
            if (file_exists("../../archivos/certificados/".PERIODO_ACTUAL."/".$nombreArchivo)) {
                unlink("../../archivos/certificados/".PERIODO_ACTUAL."/".$nombreArchivo);
            } 
    
            if ($tipoPdf == 'F') {
//                $pdfName = $camino.'/archivos/certificados/'.PERIODO_ACTUAL.'/'.$nombreArchivo;
//                
                $pdf->Output($camino.'/archivos/certificados/'.PERIODO_ACTUAL.'/'.$nombreArchivo, $destination);        
...
//                echo $nombreArchivoJpg; exit;
            ...
            if ($envioMail && isset($mail)) {
                ...
                $mail->AddAttachment("../../archivos/certificados/".PERIODO_ACTUAL."/".$nombreArchivo);
