...
//verifica el tipo para imprimir
if ($tipo == 'J') {
    $tipoEspecialista = 'Título de Especialista Jerarquizado en';
} else {
    if ($tipo == 'C') {
        $tipoEspecialista = 'Título de Especialista Consultor en';
    } else {
        $continua = FALSE;
    }
}
...
if ($continua) {
    ...
    $html = 'Se autoriza '.$al.' <u><b>'.$apellidoNombre.'</b></u> Matrícula Provincial N° <u><b>'.$matricula.'</b></u> a utilizar el <b>'.$tipoEspecialista.'</b> <u><b>'.$especialidadDetalle.'</b></u> en razón  de  haber  acreditado  los recaudos exigidos en el Reglamento de Especialidades del Decreto 5413/58, a partir del '.cambiarFechaFormatoParaMostrar($fechaAprobada).'.-';
    $x = 70;
    $y = 123;
    ...
    */
    ...
    $pdf->SetY(195);
    $pdf->MultiCell(305, 0, $laFecha, 0, 'R', false, 0, '', '');
