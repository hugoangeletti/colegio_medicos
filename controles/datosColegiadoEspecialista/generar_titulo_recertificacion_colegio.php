...
if ($continua) {
    ...
    $pdf->SetFont($fontname, '', 28);
    $html = '<p style="line-height: 1.5;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        El Colegio de Médicos de la Provincia de Buenos Aires certifica que '.$al.' <u><b>'.$apellidoNombre.'</b></u> Matrícula Provincial N° <u><b>'.$matricula.'</b></u> en razón de haber cumplimentado los recaudos exigidos en el Reglamento de Especializaciones y del Ejercicio de las mismas, según fija el Decreto 5413/58, le  otorga  la  Recertificación  de  su  Título de Especialista en <u><b>'.$especialidadDetalle.'</b></u>.';
