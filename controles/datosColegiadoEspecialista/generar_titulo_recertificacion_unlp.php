...
if ($continua) {
    ...
    //parrafo 2
    $html = 'Por lo tanto la Facultad de Ciencias Médicas de la Universidad Nacional de La Plata y el Colegio de Médicos de la Provincia de Buenos Aires, le otorgan la Recertificación del Título de Especialista en: ';
    $y = 133;
    $pdf->writeHTMLCell(320, 0, $x, $y, $html, 0, 1, 0, true, 'J', true);
