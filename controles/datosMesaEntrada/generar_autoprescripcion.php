...
if (isset($idMesaEntrada) && $idMesaEntrada > 1) {
    ...
    */
    ...
    $html = '<p style="line-height: 15em;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Tengo el agrado de dirigirme a Usted con motivo de solicitar la <b>AUTOPRESCRIPCIÓN</b> de la M.P. Nº <b>'.$matricula.'</b> perteneciente '.$dr_dra.' <b>'.$nombreRemitente.'</b> a partir del día <b>'.cambiarFechaFormatoParaMostrar($fecha).'.-</b></p>
    ...
    $y_fin_linea = 130;
    $pdf->SetXY($x_inicio, $y_fin + $y_fin_linea - 10);
    $pdf->SetFont('dejavusans', 'B', 8);
    $pdf->MultiCell(0, 5, 'Estado matricular al momento del trámite: ', 0, 'L', false, 0, '', '');
    $pdf->SetFont('dejavusans', '', 8);
    $pdf->MultiCell(0, 5, $elEstado, 0, 'L', false, 1, '90', '');
