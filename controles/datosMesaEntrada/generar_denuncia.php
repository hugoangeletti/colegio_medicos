...
if (isset($idMesaEntrada) && $idMesaEntrada > 1) {
    ...
    $pdf->Ln(5);
    $pdf->SetFont('dejavusans', 'B', 12);
    $pdf->MultiCell(0, 5, 'Denuncia de '.$nombreTipoDenuncia, 0, 'C', false, 1, '30', '');
    $pdf->Ln(2);
