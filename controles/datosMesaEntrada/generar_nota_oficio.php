...
if (isset($idMesaEntrada) && $idMesaEntrada > 1) {
    ...
    if (isset($matricula) && $matricula <> "") {
        ...
        $pdf->MultiCell(0, 7, 'Matrícula: ', 0, 'L', false, 0, '', '');
        $pdf->SetFont('dejavusans', '', 10);
        $pdf->MultiCell(0, 7, $matricula, 0, 'L', false, 1, '40', '');
    }
    $pdf->SetFont('dejavusans', 'B', 10);
    $pdf->MultiCell(0, 7, 'Remitente: ', 0, 'L', false, 0, '', '');
    $pdf->SetFont('dejavusans', '', 10);
    $pdf->MultiCell(0, 7, $nombreRemitente, 0, 'L', false, 1, '40', '');
    $html = '<b>Tema: </b>'.$tema;        
