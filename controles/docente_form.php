...
if (isset($accion)) {
    if (!empty($id_docente)) {
        ...
        if ($resDocente['estado']) {
            $docente = $resDocente['datos'];
            $apellidoNombre = $docente['apellidoNombre'];
            $idColegiado = $docente['idColegiado'];
...
if ($continua) {
    ...
    <div class="panel panel-info">
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-9">
                    <h5><?php echo $accion; ?> DOCENTE.</h5>
                </div>
                <div class="col-md-3 text-right">
                    <a href="docente_lista.php" class="btn btn-primary" >Volver</a>
                </div> 
            </div>
        </div>
        <div class="panel-body">
            <form id="datosCurso" name="datosCurso" method="POST" action="datosCurso\abm_docente.php">
                <div class="row">
                    <div class="col-md-2">
