    ...
    <div class="row">
        <div class="col-md-12">
            ...
            if ($resExpedientes['estado']){
                $permiso_editar_sin_resolucion = FALSE;
                if ($usuarioLogic->verificarRolUsuario($_SESSION['user_id'], 125)) {
                    $permiso_editar_sin_resolucion = TRUE;
                }
                ?>            
                            ...
                            if (isset($numeroResolucion)) {
                                ...
                                */
                                ...
                                <td style="text-align: center;">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <a href="datosMesaEntrada/especialidades_expedientes_imprimir.php?n_exp=<?php echo $numeroExpediente; ?>&a_exp=<?php echo $anioExpediente; ?>" target="_BLANK" class="btn btn-info btn-sm">Imprimir</a>
                                        </div>
                                    <?php 
                                    if ($fechaIngreso == date('Y-m-d') || $permiso_editar_sin_resolucion) {
                                        ...
                                        ?>
                                            <div class="col-xs-6">
                                                <form  method="POST" action="especialidades_expedientes_alta.php?accion=3">
                                                    <button type="submit" class="btn btn-info btn-sm" name='editar' id='name'>Editar</button>
