...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-xs-3 text-right">
                <a href="especialidades_expediente_pendiente_pago.php" class="btn btn-info">Volver</a>
            </div>
        </div>
    </div>
    <div class="panel-body">
        ...
        if ($continua) {
            ?>  
            <form id="formAnularDeuda" name="formAnularDeuda" method="POST" onSubmit="" action="datosMesaEntrada\anular_deuda_pendiente.php">
                <div class="row">
                    <div class="col-md-2">
