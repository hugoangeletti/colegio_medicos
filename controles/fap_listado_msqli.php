                ...
                <table id="tablaOrdenada" class="display">
                    ...
                    <tbody>
                      ...
                      foreach ($resCaratulas['datos'] as $dato) {
                          ...
                          $idSapEstado = $dato['idSapEstado'];
                          $nombreSapEstado = $dato['nombreSapEstado'];
                          $idSapCondicion = $dato['idSapCondicion'];
                          $nombreSapCondicion = $dato['nombreSapCondicion'];
                          ...
                          $numeroResolucion = $dato['numeroResolucion'];
                            if ($idSapTipoTramite == $fapLogic::TIPO_TRAMITE_CONSULTA) {
                                //si es consulta no se muestra el numerosap
                                $numeroSAP = NULL;
                            } else {
                                $numeroSAP = $dato['numeroSAP'];
                            }
                        ...
                        <tr>
                           ...
                           <td><?php echo cambiarFechaFormatoParaMostrar($fechaReunionConsejo);?></td>
                           ...
                           <td style="text-align: center;">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <?php 
                                        if ($idSapTipoTramite <> 1 && $usuarioLogic->verificarRolUsuario($_SESSION['user_id'], 128)) {
                                        ?>
