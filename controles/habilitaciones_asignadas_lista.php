...
<div class="panel-body">
    <div class="row">
        ...
        <?php
        $resHabilitaciones = $habilitacionConsultorioLogic->obtenerHabilitacionesAsignadasPorInspector($idInspector);
                            ...
                            <td>
                                <div align="center">
                                    <form name="myForm"  method="POST" action="habilitaciones_inspeccion_form.php?id=<?php echo $idInspectorHabilitacion; ?>">
                                        <button type="submit" name='confirma' id='confirma' class="btn btn-primary glyphicon glyphicon-edit center-block btn-sm"></button>
