...
<div class="panel panel-info">
    ...
    ?>
        <div class="panel-heading">
            <div class="row">
                <div class="col-md-9">
                    <h3>Generar liquidación a Docentes</h3>
                </div>
        ...
        <div class="panel-body">
            <?php
            $resPagos = $cursos_pdo->obtenerLiquidacionesDocentesPendientePago();
            if ($resPagos['estado'] && sizeof($resPagos['datos']) > 0) {
            ?>
                <form id="formLiquidacion" action="datosCurso/abm_liquidacion_cursos_docentes.php?agregar" method="POST">
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <input type="checkbox" 
                                           ...
                                           value="<?php echo $pago['IdLiquidacionCursos']; ?>" 
                                           class="check-pago"
                                           data-id-curso="<?php echo $pago['IdCursos']; ?>"
                                           data-importe="<?php echo $pago['TotalLiquidado']; ?>"
                                           onclick="actualizarInterfaz()">
                                </td>
                                <td style="text-align: left;"><?php echo $pago['IdLiquidacionCursos']; ?></td>
                                <td style="text-align: left;"><?php echo $pago['Titulo']; ?></td>
                                <td style="text-align: right;">$ <?php echo number_format($pago['TotalCobrado'], 2, ',', '.'); ?></td>
                                <td style="text-align: right;">$ <?php echo number_format($pago['TotalLiquidacion'], 2, ',', '.'); ?></td>
                                <td style="text-align: right;">$ <?php echo number_format($pago['TotalLiquidado'], 2, ',', '.'); ?></td>
                                <td style="text-align: center;">
                                    <button type="button" 
