                            ...
                            <td>
                                ...
                                switch ($idTipoMesaEntrada) {
                                    case '4':
                                        ...
                                        <?php 
                                        //si no es de la fecha actual verificamos si el usuario tiene permiso
                                        if ($fechaIngreso == date('Y-m-d') || $usuarioLogic->verificarRolUsuario($_SESSION['user_id'], 104)) {
                                            ?>
                                            <a href="mesa_entrada_habilitacion_consultorio.php?id=<?php echo $idMesaEntradaConsultorio; ?>&ingreso=<?php echo $accedePor; ?>&editar" class="btn btn-info">Editar</a>
                                        <?php
                                        }
                                        break;
                                    ...
                                    default:
                                        // otros
                                        ?>
                                        <a href="mesa_entrada_ver.php?id=<?php echo $idMesaEntrada; ?>&ingreso=<?php echo $accedePor; ?>" class="btn btn-info"><?php if ($idTipoMesaEntrada == 3) { echo 'Editar'; } else { echo 'Ver   '; } ?></a>
                                        <?php                                        
                                        break;
                                }
                                //fin ver
