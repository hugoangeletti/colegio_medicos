        ...
        if (!$ordenDelDiaLogic->ordenDelDiaConDetalle($idOrdenDia)) {
            ...
            if ($resOrdenDetalle['estado']) {
                ...
                foreach ($ordenDiaDetalle as $detalle) {
                    ...
                    /* 
                    //pidieron sacarlo el 1/6/2022, por secretarias, se envio todo a la planilla 2. Notas recibidas
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse_<?php echo $i; ?>" class="panel-collapse collapse <?php if ($i == $tipoPlanillaOrigen) { ?> in <?php } ?>">
                        <div class="panel-body">
                            ...
                            if (sizeof($ordenDelDiaTipo) > 0) {
                            ?>
                            <form id="formOrdeDia" name="formDistrito" method="POST" onSubmit="" action="datosOrdenDelDia/abm_orden_del_dia_detalle.php">
                                <?php 
                                if ($estadoOrdenDia == 'A') {
                                ?>
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            ...
                                            <input class="form-control" type="hidden" name="tipoPlanillaOrigen" id="tipoPlanillaOrigen" value="<?php echo $i; ?>" />
                                            <input class="form-control" type="hidden" name="accion" id="accion" value="4" />
                                        </div>
                                    </div>
                                <?php 
                                }
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                <td>
                                                    ...
                                                    if ($tipoPlanilla <> '1') { 
                                                    ?>
                                                        <input type="checkbox" name="deriva1[]" id="deriva1[]" value="<?php echo $idOrdenDiaDetalle ?>">&nbsp;
                                                    <?php 
                                                    } else {
                                                    ?>
                                                        <input type="checkbox" name="deriva1[]" id="deriva1[]" value="" disabled>&nbsp;
                                                    <?php    
                                                    }

                                                    if ($tipoPlanilla <> '2') { 
                                                    ?>
                                                        <input type="checkbox" name="deriva2[]" id="deriva2[]" value="<?php echo $idOrdenDiaDetalle ?>">&nbsp;
                                                    <?php 
                                                    } else {
                                                    ?>
                                                        <input type="checkbox" name="deriva2[]" id="deriva2[]" value="" disabled>&nbsp;
                                                    <?php  
                                                    }  

                                                    if ($tipoPlanilla <> '3') { 
                                                    ?>
                                                        <input type="checkbox" name="deriva3[]" id="deriva3[]" value="<?php echo $idOrdenDiaDetalle ?>">&nbsp;
                                                    <?php 
                                                    } else {
                                                    ?>
                                                        <input type="checkbox" name="deriva3[]" id="deriva3[]" value="" disabled>&nbsp;
                                                    <?php
                                                    }

                                                    if ($tipoPlanilla <> '4') { 
                                                    ?>
                                                        <input type="checkbox" name="deriva4[]" id="deriva4[]" value="<?php echo $idOrdenDiaDetalle ?>">&nbsp;
                                                    <?php 
                                                    } else {
                                                    ?>
                                                        <input type="checkbox" name="deriva4[]" id="deriva4[]" value="" disabled>&nbsp;
                                                    <?php    
                                                    }
                                                    ?>
                                                    <input type="checkbox" name="deriva5[]" value="<?php echo $idOrdenDiaDetalle ?>">
                                                  </ul>
                                                </td>
                                            <?php 
                                            }
