...
<div class="panel-heading">
    <h4>Listado seguro praxis médica ALTAS al <?php echo cambiarFechaFormatoParaMostrar($fechaLimiteProceso); ?></h4>
</div>
<div class="panel-body">
    <div class="row">
        <div class="col-md-2">
            <a href="seguro_praxis_medica_altas_archivo.php?id=<?php echo $idSeguro; ?>" class="btn btn-primary">Descargar archivo</a>
        </div>
