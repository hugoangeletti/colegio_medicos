...
<div class="panel-heading">
    <h4>Listado seguro praxis médica BAJAS al <?php echo cambiarFechaFormatoParaMostrar($fechaLimiteProceso); ?></h4>
</div>
<div class="panel-body">
    <div class="row">
        <div class="col-md-2">
            <a href="seguro_praxis_medica_bajas_archivo.php?id=<?php echo $idSeguro; ?>" class="btn btn-primary">Descargar archivo</a>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <?php
            $resSeguroProcesado = $colegiado_seguro_Logic->obtenerSegurosProcesadosBajas($idSeguro);
            if ($resSeguroProcesado['estado']) {
            ?>
