...
define("PATH_PDF", "desarrollo/colegio");

define("HOST", '192.168.2.50');
define("BASE_NAME", 'pruebas_colmed1');
...
define("VENCIMIENTO_TRIMESTRE_UNO", date('Y')."-09-30");
define("VENCIMIENTO_TRIMESTRE_DOS", date('Y')."-12-31");
define("VENCIMIENTO_TRIMESTRE_TRES", (date('Y')+1)."-03-31");
define("VENCIMIENTO_TRIMESTRE_CUATRO", (date('Y')+1)."-06-30");
